...
export class PortfolioComponent implements OnInit {
  projects: Project[] = [
    new Project(
      ...
      'Louisiana Economic Development (LED) approached our team needing a solution to help Louisiana residents and businesses fill jobs. Along with filling jobs, they wanted to give businesses incentives to come to Louisiana.',
      // tslint:disable-next-line:max-line-length
    ...
    new Project(
      ...
      // tslint:disable-next-line:max-line-length
      'Southeast Louisiana Flood Protection Authority - East (SLFPA-E) needed to overhaul their old school levee permit application process. They wanted a faster and more efficient way for applicants to submit and track permit applications electronically.',
      // tslint:disable-next-line:max-line-length
    ...
    new Project(
      ...
      'signal_logo.png',
      // tslint:disable-next-line:max-line-length
      'Bambarger Intellectual Properties (BIP) had a vision for a fully customizable location tracking service. The client wanted the ability turn any iOS or Android phone/tablet into a tracking point, then view these points and manage them from a web interface. They also needed an effective way to distribute and sell this service.',
      // tslint:disable-next-line:max-line-length
      ...
      // tslint:disable-next-line:max-line-length
      'My role in this project involved setting up the initial front-end file structure and bringing the static mockups for the entire web app to life. There were concerns about the UI not taking advantage of the screen space in some of the UI and unintuitive UX I worked with the team to resolve. My favorite challenges for this project involved working with the Google Maps API to help build/optimize the tracking UI, setting up the themed web app UI based on the company’s brand guidelines, and developing the templates on the e-commerce site.',
      // tslint:disable-next-line:max-line-length
    ...
    new Project(
      ...
      'pulsario_logo.png',
      // tslint:disable-next-line:max-line-length
      'Prevail Heart Clinics required a way to communicate to patients with heart problems and were unable to physically make it to appointments. They needed an effective way to monitor patients remotely. That\'s when the idea of developing a web and mobile app for tracking patients\' health statuses materialized.',
      // tslint:disable-next-line:max-line-length
      ...
      // tslint:disable-next-line:max-line-length
      'I was responsible for all the front-end aspects of this project. I developed the public facing site using the mockups provided by our designers. The biggest challenge came with the internal web app development. The back-end development was moving faster than I was so many of the views were being generated first and I went in afterwards to integrate them. It was a chance to think in a different way than I am normally used to. A few months after the site and application launched, they went through a rebranding. I was tasked with handling all the UI rebranding for the web app.',
    ...
    new Project(
      ...
      // tslint:disable-next-line:max-line-length
      'I was tasked with the research and setting up of DNN before the project kicked off because it was the first time our team was working with DNN. When the project received the green light, I went to work customizing, theming and creating views within DNN using the mockups from our designers. Along with the desktop web app, I also optimized the site for mobile device consumption. The biggest challenge I encountered was figuring out the ins and outs of DNN so I could integrate my work correctly. I am accustomed to starting from scratch so this was a welcome challenge and nice change of pace.',
      // tslint:disable-next-line:max-line-length
